import svgPaths from "./svg-y438xgpzmq";
import imgHttpsLottiefilesComAnimationsSpinnerSNtIs84F4Q from "figma:asset/746f807cda5d5d54e940de9210dfd0215d4d9d73.png";
...
function Component() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-[465px]" data-name="Component 6">
      <p className="font-['IBM_Plex_Sans',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#021c20] text-[16px] text-center w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        Hämtar fastigheter...
      </p>
    </div>
  );
  ...
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-center relative shrink-0 w-full">
      ...
      <div className="relative shrink-0 size-[48px]" data-name="https://lottiefiles.com/animations/spinner-sNtIs84f4q">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgHttpsLottiefilesComAnimationsSpinnerSNtIs84F4Q} />
      </div>
      <Component />
    </div>
  );
