import svgPaths from "./svg-89n0prm9l6";
...
function Button() {
  return (
    <div className="bg-[#1e3856] relative shrink-0 w-full z-[1]" data-name="Button">
...
function Main() {
  return (
    <div className="content-stretch flex flex-col isolate items-start min-w-[464px] pb-[16px] pt-0 px-0 relative shrink-0 w-[464px]" data-name="Main">
      <Button />
    </div>
  );
}
...
function Frame12() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[40px] items-center px-[80px] py-[40px] relative shadow-[0px_4px_24px_0px_rgba(0,0,0,0.04)] shrink-0">
      <Frame1 />
      <Frame2 />
    </div>
  );
