...
function DropdownMenu({
  ...
  return <DropdownMenuPrimitive.Root data-slot="dropdown-menu" modal={false} {...filterFigmaProps(props)} />;
}
  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        onInteractOutside={(e) => {
          // Ensure outside clicks always close the menu in non-modal mode
