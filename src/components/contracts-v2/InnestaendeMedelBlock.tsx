        ...
        {total === 0 ? (
          ...
          <div className="@container">
            <div className="flex flex-col @[520px]:flex-row @[520px]:items-center gap-[20px] @[520px]:gap-[24px]">
              ...
              <div className="relative h-[260px] @[520px]:h-[230px] @[640px]:h-[280px] @[820px]:h-[320px] w-full max-w-[320px] mx-auto @[520px]:w-[230px] @[640px]:w-[280px] @[820px]:w-[320px] @[520px]:shrink-0">
