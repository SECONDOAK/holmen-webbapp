 ...
 *     i primary (navy #1e3856) + white outlined, accent #1E3856 (navy)
...
// Designsystemets `--h-blue-1` (Holmens primary navy).
// Anvands for accent-element: ikon-cirklar, check-bullets, eyebrow-labels.
// Variabelnamnet ar oforandrat for att slippa refactor om vi byter
// accent-far again i framtiden.
const HOLMEN_GREEN = '#1E3856';
const NAVY = '#1e3856';
      ...
      <div className="max-w-[1200px] mx-auto px-[16px] md:px-[40px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-[40px] md:gap-[64px] items-center">
          <div className="flex flex-col">
            <Eyebrow className="text-[#1E3856]">Din skog samlad på ett ställe</Eyebrow>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-stretch">
        ...
        <div className="flex flex-col justify-center px-[16px] md:pl-[40px] md:pr-[64px] lg:pr-[80px] py-[56px] md:py-[96px]">
          <div className="max-w-[520px] md:ml-auto">
            <Eyebrow className="text-[#1E3856]">Kartan som gör skogen lättare att förstå</Eyebrow>
            <SectionHeading className="text-[#021c20] mt-[16px] md:mt-[20px]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-stretch">
        ...
        <div className="flex flex-col justify-center px-[16px] md:pl-[64px] lg:pl-[80px] md:pr-[40px] py-[56px] md:py-[96px]">
          <div className="max-w-[520px]">
            <Eyebrow className="text-[#1E3856]">Fatta tryggare beslut om din skog</Eyebrow>
            <SectionHeading className="text-[#021c20] mt-[16px] md:mt-[20px]">
...
function StepsSection() {
  return (
    <section className="bg-[#f7f7f7] py-[72px] md:py-[96px]">
      <div className="max-w-[1200px] mx-auto px-[16px] md:px-[40px]">
        <Eyebrow className="text-[#1E3856]">Så kommer du igång</Eyebrow>
  ...
  return (
    <section className="bg-white py-[72px] md:py-[120px]">
      <div className="max-w-[1200px] mx-auto px-[16px] md:px-[40px]">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-[40px] md:gap-[64px] items-center">
          <div className="flex flex-col">
            <Eyebrow className="text-[#1E3856]">Samma skog, oavsett skärm</Eyebrow>
            <SectionHeading className="text-[#021c20] mt-[16px] md:mt-[20px]">
